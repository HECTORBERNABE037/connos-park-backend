"""
Configuración base de Django para CONNOS Park
Configuraciones compartidas entre todos los entornos
"""
...
# Decirle a Django que use Cloudinary para los archivos media (subidos por usuarios)
